[‰∏≠Êñá‰ªãÁªç](https://github.com/liaosanity/shs/blob/master/README.zh_CN.md)
...
./install.sh demo
./serverctl start
WARN: If you want to change '/home/test', don°Øt forget to change them all in thes 'tools/install.sh & etc/*' files.
4) If you run a http request via chrome like this:
http://192.168.1.11:7007/shs_test/test?uid=Jeremy&sid=123456
Then you°Øll get these results as bellow:
