...
#define time_timeofday() (struct timeval *) shs_time

extern volatile string_t        shs_err_log_time;
extern volatile rb_msec_t       shs_current_msec;
extern volatile struct timeval *shs_time;
